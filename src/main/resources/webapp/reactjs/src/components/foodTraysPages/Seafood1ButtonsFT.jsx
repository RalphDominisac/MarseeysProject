  ...
  return (
    <React.Fragment>
      <Stack spacing={0} direction="row" sx={{ mb: 4.5 }}>
        ...
        <ItemsCategoryButton
          title="Buttered Garlic Shrimps (Party)"
          price="1500.00"
          availables="20"
        />
        ...
        <ItemsCategoryButton
          title="Buttered Garlic Tahong (Party)"
          price="1000.00"
          availables="20"
        />
