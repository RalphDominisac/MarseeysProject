...
export default function EditEmployee() {
	...
	useEffect(() => {
        ...
        setEmployeeRequest({
            ...
            contactNo: editEmployee.contactNo,
            civilStatus: editEmployee.civilStatus,
            birthday: editEmployee.birthday,
            shift: editEmployee.shift.id,
            address: editEmployee.address,
            department: editEmployee.department.id,
        })
	...
	function submitEmployeeRequest(event) {
		...
		axiosInstance
			.post('/employees/edit/' + editEmployee.id, employeeRequest)
			.then((response) => {
	...
	return (
		<div>
			<Card className="border border-dark bg-dark text-white">
				<Card.Header>
					<i className="fa fa-edit" /> Employee
				</Card.Header>
				<Form
					onReset={resetForm}
